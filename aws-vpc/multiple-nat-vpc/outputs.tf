...
# Outputs for Application Subnets
output "subnets_application" {
    description = "The configuration of all Application subnets"
    value = module.subnets_application.subnets
}

# Outputs for Application Route Tables
output "application_route_table_id" {
    description = "ID of Dedicated route table for Application subnets"
    value       = module.subnets_application.route_table_id
}

# Outputs for Database Subnets
output "subnets_database" {
    description = "The configuration of all Database subnets"
    value = module.subnets_database.subnets
}

# Outputs for Database Route Tables
output "database_route_table_id" {
    description = "ID of Dedicated route table for Database subnets"
    value       = module.subnets_database.route_table_id
}

# NAT Gateway Configs
output nat_gatways_config {    
    description = "The Nat gateway Details"
    value = module.subnets_infra.nat_gatways_config
}