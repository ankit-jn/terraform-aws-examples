...
This Example configuration is a demonstration of [Module: Terraform AWS VPC](https://github.com/ankit-jn/terraform-aws-vpc) utilization to create a Enhanced AWS VPC with the following features:
