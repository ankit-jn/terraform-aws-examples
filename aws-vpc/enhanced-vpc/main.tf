...
module "vpc" {
    ...
    create_igw_ipv4_route = true # Default true so can omit this property
    create_igw_ipv6_route = true
...
module "subnets_application" {
    ...
    create_igw_ipv6_route = false # Default false so can omit this property
