...
Refer [Configuration Example](https://github.com/ankit-jn/terraform-aws-examples/tree/main/aws-devops/codecommit) for the code-base to utilize [Module: Terraform AWS DevOps](https://github.com/ankit-jn/terraform-aws-modules/tree/main/aws-modules/tree/main/aws-devops) in order to create CodeCommit repository.
...
Refer [Configuration Example](https://github.com/ankit-jn/terraform-aws-examples/tree/main/aws-devops/pipeline-sam) for the code-base to utilize [Module: Terraform AWS DevOps](https://github.com/ankit-jn/terraform-aws-modules/tree/main/aws-modules/tree/main/aws-devops) in order to facilitate Serverless Application Model deployment.
