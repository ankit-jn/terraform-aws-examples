name = "arjstack-fifo-execution.fifo"
fifo_queue = true
...
enable_redrive = true
dead_letter_queue_arn = "arn:aws:sqs:ap-south-1:112233445566:my-dead-letter-queue.fifo"
maximum_receives = 5

allow_redrive = true
redrive_permission = "byQueue"
source_queues = [
    "arn:aws:sqs:ap-south-1:112233445566:arjstack-hrms-queue.fifo"
]
